    ...
    <header>
      <div class="wrap_header">
        <div class="left">
          ...
          <div class="text">실시간 검색어와 연관된 주식 종목을 찾아 그래프 분석 및 머신 러닝을 사용하여 종목의 익일 주가 예측값을 제공하는 사이트입니다.   <br>모든 분석 결과는 100%의 정확도를 보장하지 않습니다. 또한 주가 예측 값은 어디까지나 단순 예측일 뿐이니 해당 주식의 매수 여부는 직접 판단해주시길 바랍니다. 주식을 처음 접하는 분들이나 개인 투자자, 또는 실시간 주식 동향에 관심이 있는 투자자 분들께 도움이 되길 바랍니다.
            </div>
        </div>
        <div class="right">
